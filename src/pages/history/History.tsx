                ...
                <TabContext value={value}>
                    <Box sx={{ borderBottom: 1, borderColor: 'divider', justifyContent: 'center', alignItems: 'center', display: 'flex' }}>
                        <TabList variant='fullWidth' textColor="secondary"
                            ...
                            <Tab icon={<PersonIcon />} iconPosition="start" sx={{ ...(widthSmallerThen227(width) && { fontSize: '8px' }) }} label={constantsText.DOCTORS} value="2" />
...
const History = () => {
    ...
    return (
        <div className='history-container'>
            <div className="history-text">{constantsText.HISTORY}</div>
            <hr />
