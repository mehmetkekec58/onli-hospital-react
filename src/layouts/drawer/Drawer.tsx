...
const Drawer: React.FC<Props> = ({ openDrawer }: Props) => {
    const activeMenus: boolean[] = [true, false, false, true, true, true, true, true, true, true, true, true]
    ...
    const menus: (string | undefined)[] = [containTexts.homePage, containTexts.login, containTexts.register, containTexts.editProfile, containTexts.addArticle, containTexts.payments, containTexts.loadMoney, containTexts.history, containTexts.readingList, containTexts.settings, containTexts.logout, containTexts.about]
